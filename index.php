            ...
            <div class="office-holder">
                ...
                <form>
                    <div class="form-holder">
                        ...
                        <p style="color:#000; margin-top:1em; float: left; width:100%;">can't access your account?</p>
                        <p style="color:#000; margin-top:0em; float: left; width:100%;">Sign in with a single-use code</p>
                    </div>
